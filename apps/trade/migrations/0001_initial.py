# Generated by Django 2.0.1 on 2018-08-20 17:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_status', models.CharField(choices=[('TRADE_SUCCESS', '成功'), ('TRADE_CLOSED', '超时关闭'), ('WAIT_BUYER_PAY', '交易创建'), ('TRADE_FINISHED', '交易结束'), ('paying', '待支付')], default='paying', max_length=10, verbose_name='支付类型')),
                ('pay_type', models.CharField(choices=[('alipay', '支付宝'), ('weichat', '微信')], default='alipay', max_length=10, verbose_name='支付类型')),
